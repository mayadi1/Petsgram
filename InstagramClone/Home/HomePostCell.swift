...
//        likeCounter.anchor(top: likeButton.bottomAnchor, left: leftAnchor, paddingTop: padding, paddingLeft: padding)
        ...
        captionLabel.anchor(top: likeButton.bottomAnchor, left: leftAnchor, right: rightAnchor, paddingTop: padding - 6, paddingLeft: padding, paddingRight: padding)
    }
    
    private func setupActionButtons() {
        let stackView = UIStackView(arrangedSubviews: [likeButton, likeCounter, commentButton, commentCounter])
    ...
    private func setLikes(to value: Int) {
        if value <= 0 {
            ...
            likeCounter.text = "1 love it"
        } else {
            likeCounter.text = "\(value) loves it"
        }
    }
    
    private func setComments(to value: Int) {
        if value <= 0 {
            commentCounter.text = ""
        } else if value == 1 {
